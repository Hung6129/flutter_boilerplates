...
//     OneSignal.initialize("61b55a70-26fa-49b1-85eb-00d580bdb76f");
...
//     /// will be shown to the user
//     Map<String, String> triggers = Map<String, String>();
...
//                   ]),
//                   TableRow(children: [
//                     OneSignalButton("Get External User ID",
...
//                   ]),
//                   TableRow(children: [
//                     OneSignalButton("Get OneSignal ID", _handleGetOnesignalId,
//                         !_enableConsentButton)
//                   ]),
//                   TableRow(children: [
//                     TextField(
...
//                   ]),
//                   TableRow(children: [
//                     OneSignalButton("Start Default Live Activity",
//                         _handleStartDefaultLiveActivity, !_enableConsentButton)
//                   ]),
//                   TableRow(children: [
//                     OneSignalButton("Enter Live Activity",
//                         _handleEnterLiveActivity, !_enableConsentButton)
//                   ]),
//                   TableRow(children: [
//                     OneSignalButton("Exit Live Activity",

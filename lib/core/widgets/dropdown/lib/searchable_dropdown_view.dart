...
import '../../chip/app_chip_dropdown_widget.dart';
...
class SearchableDropdown<T> extends StatefulWidget {
  ...
  final void Function(String? value)? onSearchTextSubmission;
...
class _SearchableDropdownState<T> extends State<SearchableDropdown<T>> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      key: controller.key,
      width: (widget.isBorderWidget || widget.isChip)
          ? null
          : MediaQuery.of(context).size.width,
      child: widget.isChip
          ? _buildDropDownChip(context, controller)
          : widget.backgroundDecoration != null
      ...
      child: InputDecorator(
        ...
        decoration: InputDecoration(
          ...
          errorBorder: UnderlineInputBorder(
            borderSide: BorderSide(color: AppColors.get().errorColor, width: 1),
          ),
      ...
      child: InputDecorator(
        ...
        decoration: InputDecoration(
            ...
            errorBorder: OutlineInputBorder(
              borderSide:
                  BorderSide(color: AppColors.get().errorColor, width: 1),
              borderRadius: const BorderRadius.all(
                Radius.circular(8.0),
              ),
            ),
        ...
        Flexible(
          child: Card(
            ...
            child: Column(
              ...
              children: [
                if (widget.isHasSearchBox) buildSearchBar(context, controller),
                Flexible(
  ...
  Padding buildSearchBar(
    ...
    return Padding(
      ...
      child: CustomSearchBar(
        ...
        hintText: widget.searchHintText ?? 'Tìm kiếm',
        isOutlined: false,
        leadingIcon: Icon(Icons.search,
            size: MediaQuery.of(context).size.height * 0.033),
        onSubmission: (value) {
          widget.onSearchTextSubmission?.call(value);
  ...
  Widget _buildDropDownChip(
      BuildContext context, SearchableDropdownController<T> controller) {
    return AppChipDropdownWidget(
      hint: widget.chipLabel ?? '',
      isSelected: widget.value != null,
      onPressed: () => _dropDownOnTab(context, controller),
    );
  }
}

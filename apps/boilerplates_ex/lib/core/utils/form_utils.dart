...
import 'package:flutter_boilerplates/config/constants/form_key.dart';
...
import 'package:flutter_boilerplates/core/widgets/texts/myapp_text_field_widget.dart';
...
class FormUtils {
  ...
  ///
  static Widget renderMyInputField(
    BuildContext context, {
    required key,
    required String label,
    required String hintText,

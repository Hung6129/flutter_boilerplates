...
class MyAppTextFieldWidget extends StatefulWidget {
  const MyAppTextFieldWidget({
    super.key,
    required this.label,
  ...
  @override
  State<MyAppTextFieldWidget> createState() => _MyAppTextFieldWidgetState();
}

class _MyAppTextFieldWidgetState extends State<MyAppTextFieldWidget> {
  ...
  @override
  void didUpdateWidget(covariant MyAppTextFieldWidget oldWidget) {
    ...
    //         TextPosition(offset: widget.initValue?.length ?? 0),
    //       ),
    //     ),
    //   );
    // }
